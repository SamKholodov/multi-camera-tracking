...
from core.cmc.base_cmc import BaseCMC
...
_CMC_REGISTRY: Mapping[str, Callable[[], Type[BaseCMC]]] = {
    "ecc": _LazyLoader("core.cmc.ecc", "ECC"),
    "orb": _LazyLoader("core.cmc.orb", "ORB"),
    "sof": _LazyLoader("core.cmc.sof", "SOF"),
    "sift": _LazyLoader("core.cmc.sift", "SIFT"),
}
