...
from core.utils.iou import AssociationFunction
...
class BaseTracker(ABC):
    def __init__(
        ...
        **kwargs,
        ...
        self.asso_func = AssociationFunction(w=640, h=640, asso_mode=self.asso_func_name).asso_func
        self.is_obb = is_obb
    ...
    def plot_box_on_img(
        ...
        if self.is_obb:
            ...
            box_poly = np.asarray(rotrec, dtype=np.int32)
