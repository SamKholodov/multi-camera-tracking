...
from core.reid.utils.checks import RequirementsChecker
from core.reid.utils.misc import resolve_model_path
    ...
    def download_model(self, w):
        ...
        with lock:
            ...
            if model_url:
                ...
                from core.reid.utils.download import download_file
