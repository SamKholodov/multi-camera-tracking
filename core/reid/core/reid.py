...
from core.reid.detectors.base import resolve_image
from core.reid.backends.onnx_backend import ONNXBackend
from core.reid.backends.pytorch_backend import PyTorchBackend
...
from core.reid.utils.torch_utils import select_device
...
class ReID:
    ...
    def from_backend(cls, backend: Any) -> "ReID":
        ...
        instance.pt = instance.onnx = False
    ...
    def _prepare_crop_batch(self, crops: list[np.ndarray]) -> torch.Tensor:
        ...
        from core.reid.core.preprocessing import get_preprocess_fn
